...
div.w-full.max-w-sm.bg-white.border.border-gray-200.rounded-lg.shadow
      div.flex.flex-col.items-center.pb-4
            img(src=`${imgUrl}` alt="Bonnie image").w-24.h-24.mb-3.rounded-full.shadow-lg
            div.flex
                  button.bg-transparent.text-gray-500.font-semibold.p-1.border.border-gray-500.rounded.mr-3.my-3
